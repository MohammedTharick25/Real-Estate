  ...
  return (
    <section className="py-20 bg-slate-50 dark:bg-slate-950 transition-colors">
      <div className="max-w-7xl mx-auto px-4">
        {/* Heading */}
        <h2 className="text-3xl md:text-4xl font-black text-center mb-12 text-slate-900 dark:text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((r, i) => (
            ...
            >
              ...
              {/* Role */}
              <span className="text-sm text-brand font-medium">{r.role}</span>
            </motion.div>
          ))}
        </div>
      </div>
